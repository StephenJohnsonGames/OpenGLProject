...
static GLuint quadVertexBuffer, quadTextureCoordBuffer, quadVertexIndices;
...
void CGTexturedQuad::setupVAO() {
	...
	glGenBuffers(1, &quadVertexIndices);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, quadVertexIndices);
